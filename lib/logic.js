...
var ROOT_NAMESPACE = 'org.example.todolist';
var USER = ROOT_NAMESPACE + '.User';
var TASK = ROOT_NAMESPACE + '.Task';
...
function onBootstrap(txn) {
    ...
    var catwoman = factory.newResource(ROOT_NAMESPACE,
                                       'User',
    ...
    var task1 = factory.newResource(ROOT_NAMESPACE,
                                    'Task',
                                    'Task-' + taskCounter++);
    ...
    var task2 = factory.newResource(ROOT_NAMESPACE,
                                    'Task',
                                    'Task-' + taskCounter++);
    ...
    var task3 = factory.newResource(ROOT_NAMESPACE,
                                    'Task',
                                    'Task-' + taskCounter++);
    ...
    var task4 = factory.newResource(ROOT_NAMESPACE,
                                    'Task',
                                    'Task-' + taskCounter++);
    ...
    var task5 = factory.newResource(ROOT_NAMESPACE,
                                    'Task',
                                    'Task-' + taskCounter++);
...
function onAssignTask(txn) {
    ...
    return getAssetRegistry(TASK)
          .then(function(assetRegistry) {
              return assetRegistry.update(txn.task);
          }
    );
}
...
function onCreateTask(txn) {
    ...
    var userForeignKey = factory.newRelationship(ROOT_NAMESPACE,
                                                 'User',
                                                 txn.transactionExecutor.email);
    var task = factory.newResource(ROOT_NAMESPACE,
                                   'Task',
                                   txn.taskId);
...
function onDeleteTask(txn) {
    ...
    return getAssetRegistry(TASK)
          .then(function(assetRegistry) {
              return assetRegistry.remove(txn.task);
          }
    );
}
...
function onCreateUser(txn) {
    ...
    var factory = getFactory();
    var user = factory.newResource(ROOT_NAMESPACE,
                                   'User',
                                   txn.userEmail);
